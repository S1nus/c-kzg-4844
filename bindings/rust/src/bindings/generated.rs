...
extern "C" {
    pub fn load_trusted_setup(
        ...
        g2_bytes: *const u8,
        n2: usize,
        tmp1: *mut *mut ::core::ffi::c_void,
        tmp2: *mut *mut ::core::ffi::c_void,
        expanded_roots: *mut fr_t,
    ) -> C_KZG_RET;
    ...
    pub fn blob_to_kzg_commitment(
        ...
        p_affine: *mut blst_p1_affine,
        scalars: *mut blst_scalar,
    ) -> C_KZG_RET;
    pub fn compute_kzg_proof(
        ...
        s: *const KZGSettings,
        lincomb_scratch: *mut ::core::ffi::c_void,
        lincomb_p1s: *mut blst_p1_affine,
        lincomb_scalars: *mut blst_scalar,
        inverses_in: *mut fr_t,
        inverses: *mut fr_t,
    ) -> C_KZG_RET;
    pub fn compute_blob_kzg_proof(
        ...
        lincomb_scratch: *mut ::core::ffi::c_void,
        lincomb_p1s: *mut blst_p1_affine,
        limbcom_scalars: *mut blst_scalar,
        inverses_in: *mut fr_t,
        inverses: *mut fr_t,
    ) -> C_KZG_RET;
